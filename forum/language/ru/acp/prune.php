...
$lang = array_merge($lang, array(
	'ACP_PRUNE_USERS_EXPLAIN'		=> 'Здесь Вы можете удалять или блокировать пользователей форума. Аккаунты можно отфильтровать различными способами — по количеству сообщений, по времени последнего посещения, т. д. Критерии могут быть объединены с целью сокращения аккаунтов, к которым будет применена очистка. Например, Вы можете удалить пользователей, которые не посещали форум после 01.01.2002, и имеющих менее 10 сообщений. Используйте * в качестве шаблона для текстовых полей. Либо, Вы можете полностью пропустить эту опцию введя список пользователей (каждого на отдельной строке) в текстовое поле. Будьте осторожны с этим инструментом — восстановление удалённых пользователей невозможно!',
	...
	'JOINED_EXPLAIN'				=> 'Введите дату в формате <kbd>ГГГГ-ММ-ДД</kbd>. Вы можете использовать оба поля для выбора конкретного интервала, или оставить одно пустым для открытой диапазона.',
	...
	'PRUNE_USERS_GROUP_EXPLAIN'		=> 'Ограничения для пользователей в пределах выбранной группы.',
