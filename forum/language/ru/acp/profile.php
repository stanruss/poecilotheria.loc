...
$lang = array_merge($lang, array(
	...
	'DISPLAY_ON_PM'						=> 'Показывать при просмотре экрана ЛС',
	'DISPLAY_ON_PM_EXPLAIN'				=> 'Если опция включена, поле будет отображаться в мини-профиле при просмотре экрана ЛС.',
