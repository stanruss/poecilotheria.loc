...
$lang = array_merge($lang, array(
	'PLUPLOAD_ADD_FILES'		=> 'Добавьте файлы',
	'PLUPLOAD_ADD_FILES_TO_QUEUE'	=> 'Добавьте файлы в очередь загрузок и нажмите клавишу для начала.',
	'PLUPLOAD_ALREADY_QUEUED'	=> '%s уже присутствует в очереди.',
	'PLUPLOAD_CLOSE'			=> 'Закрыть',
	'PLUPLOAD_DRAG'				=> 'Перетащите файлы сюда.',
	...
	'PLUPLOAD_ERR_INPUT'		=> 'Ошибка открытия исходящего потока.',
	'PLUPLOAD_ERR_MOVE_UPLOADED'	=> 'Ошибка перемещения загружаемого файла.',
	'PLUPLOAD_ERR_OUTPUT'			=> 'Ошибка открытия входящего потока.',
	...
	'PLUPLOAD_FILES_QUEUED'		=> '%d файлов в очереди',
	...
	'PLUPLOAD_NOT_APPLICABLE'	=> 'Ошибка несовместимости',
	'PLUPLOAD_SECURITY_ERROR'	=> 'Ошибка безопасности.',
	'PLUPLOAD_SELECT_FILES'		=> 'Выбор файлов',
	'PLUPLOAD_SIZE'				=> 'Размер',
	'PLUPLOAD_SIZE_ERROR'		=> 'Ошибка размера файла.',
	'PLUPLOAD_STATUS'			=> 'Статус',
	'PLUPLOAD_START_UPLOAD'		=> 'Начать загрузку',
	'PLUPLOAD_START_CURRENT_UPLOAD'	=> 'Начать очередь загрузок',
